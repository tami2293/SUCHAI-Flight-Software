...
def parse_args():
    ...
    parser.add_argument('--fp', type=str, default="0")
    parser.add_argument('--hk', type=str, default="0")
    ...
    parser.add_argument('--zmq_in', type=str, default="ipc:///tmp/suchaifs:8001")
    parser.add_argument('--zmq_out', type=str, default="ipc:///tmp/suchaifs:8002")
    parser.add_argument('--st_mode', type=str, default="2")
